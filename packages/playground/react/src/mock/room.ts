...
import type { MemberState, Room, RoomCallbacks, SceneDefinition } from "white-web-sdk";

import { ApplianceNames } from "white-web-sdk";
import { MockCallbacks } from "./callbacks";
import { log } from "./helpers";

export class MockRoom implements PartialDeep<Room> {
  callbacks = new MockCallbacks<RoomCallbacks>();
  isWritable = true;
