...
createFastboard({
  ...
  joinRoom: {
    uid: genUID(),
    uuid: import.meta.env.VITE_ROOM_UUID || "49d52d8015ef11f0af9493648faf1aac",
    // floatBar: {
    //   colors: [
    //       [224, 32, 32],
    //       [247, 181, 0],
    ...
    roomToken:
      ...
      "NETLESSROOM_",
  },
  managerConfig: {
    cursor: true,
  },
