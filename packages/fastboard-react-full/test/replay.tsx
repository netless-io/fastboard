...
import type { FastboardPlayer, Theme, Language } from "@netless/fastboard-react-full";

import React, { useCallback, useEffect, useState } from "react";
import ReactDOM from "react-dom";
import { resizable } from "@netless/fastboard-ui/test/resizable";
import { replayFastboard, ReplayFastboard } from "@netless/fastboard-react-full";
import "./style.scss";
...
function App() {
  ...
  useEffect(() => {
    let playerInstance: FastboardPlayer | undefined;
    ...
    replayFastboard({
      ...
      setPlayer((playerInstance = player));
    });
